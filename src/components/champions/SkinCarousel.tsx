...
export default function SkinCarousel({ skins, championId }: SkinCarouselProps) {
    ...
    return (
        ...
        >
            ...
            {/* Skin Info */}
            <div className="absolute bottom-0 left-0 right-0 p-8 text-center z-10 pointer-events-none">
                <motion.h2
                ...
                {/* Indicators */}
                <div className="flex justify-center gap-2 mt-4 flex-wrap px-10 pointer-events-auto">
                    {skins.map((_, idx) => (
                        <button
                            key={idx}
                            onClick={() => {
