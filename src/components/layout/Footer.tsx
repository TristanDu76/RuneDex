        ...
        <footer className="mt-auto border-t border-gray-800 bg-gray-900/50 backdrop-blur-sm">
            <div className="max-w-7xl mx-auto px-4 py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {/* About Section */}
                    <div>
                        <h3 className="text-lg font-bold text-yellow-400 mb-3">RuneDex</h3>
                    ...
                    {/* Links Section */}
                    <div>
                        <h3 className="text-lg font-bold text-yellow-400 mb-3">{t('footer.links')}</h3>
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link href="/map" className="text-gray-400 hover:text-yellow-400 transition-colors text-sm">
                                    {t('map.title')}
                                </Link>
                            </li>
                            <li>
                                <Link href="/quiz" className="text-gray-400 hover:text-yellow-400 transition-colors text-sm">
                                    {t('quiz.hubTitle')}
                                </Link>
                            </li>
                        </ul>
                    ...
                    {/* Community Section */}
                    <div>
                        <h3 className="text-lg font-bold text-yellow-400 mb-3">{t('footer.community')}</h3>
                        <a
                            href="https://discord.gg/R2VX8KnFwP"
                            target="_blank"
                ...
                <div className="mt-8 pt-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">
                        © {new Date().getFullYear()} RuneDex. {t('footer.allRightsReserved')}
                    </p>
                    <p className="text-gray-500 text-sm">
                        {t('footer.createdBy')}{' '}
                        <a
